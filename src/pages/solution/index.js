...
export default function MainSolution() {
  ...
  const featuresGroup3 = [
    ...
    },
    {
      ...
      content:
        "Create and manage custom workflows to suit your business needs.",
      icon: "settings",
    },
  ];
      ...
      <div className="business_toolkit_wrapper">
        <div className="row align-items-center justify-content-center">
          <div className="col-md-11 col-lg-9">
            <h3
              className={`${roboto.className} fw-bold business_toolkit_header`}
            >
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-11 col-lg-9">
            <div className="row">
              {featuresGroup1.map((item, index) => (
                <div
                  className="col-md-6 col-lg-4 business_toolkit_card_wrapper"
                  key={index}
                >
                  <Link
                    href={`/industry/${item.title.toLowerCase()}`}
                    style={{ textDecoration: "none" }}
                    className="card business_toolkit_card  bd-top-green"
                  >
                    <div className="card-body p-0">
                      <div className="icon position-relative ratio ratio-1x1 img_wrapper">
                        <Image
                          src="/images/pages/help-center/icon.svg"
                          alt="upload"
                          fill
                      ...
                      <Link
                        className="d-flex align-items-center justify-content-between w-100 link_btn py-0"
                        href={`/industry/${item.title.toLowerCase()}`}
                      >
              ...
              {featuresGroup2.map((item, index) => (
                ...
                >
                  <Link
                    href={`/industry/${item.title.toLowerCase()}`}
                    style={{ textDecoration: "none" }}
                    className="card business_toolkit_card  bd-top-blue"
                  >
                    <div className="card-body p-0">
                      <div className="icon position-relative ratio ratio-1x1 img_wrapper">
                        <Image
              ...
              {featuresGroup3.map((item, index) => (
                ...
                >
                  <Link
                    href={`/industry/${item.title.toLowerCase()}`}
                    style={{ textDecoration: "none" }}
                    className="card business_toolkit_card  bd-top-purple"
                  >
                    <div className="card-body p-0">
                      <div className="icon position-relative ratio ratio-1x1 img_wrapper">
                        <Image
