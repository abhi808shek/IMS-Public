                    ...
                    .map((_) => (
                      <div className="col-md-6 col-lg-4 mb-5 pe-4 ">
                        <Link
                          ...
                          class="card py-4 px-2 main-solution-card bd-top-green"
                        >
                          <div class="card-body">
                    ...
                    .map((_) => (
                      <div className="col-md-6 col-lg-4 mb-5 pe-4 ">
                        <Link
                          href="/each-solution"
                          style={{ textDecoration: "none" }}
                          class="card py-4 px-2 main-solution-card bd-top-blue"
                        >
                          <div class="card-body">
                            <div className="icon position-relative ms-2 mb-3 ratio ratio-1x1 img_wrapper">
                              <Image
                    ...
                    .map((_) => (
                      <div className="col-md-6 col-lg-4 mb-5 pe-4 ">
                        <Link
                          href="/each-solution"
                          style={{ textDecoration: "none" }}
                          class="card py-4 px-2 main-solution-card bd-top-purple"
                        >
                          <div class="card-body">
                            <div className="icon position-relative ms-2 mb-3 ratio ratio-1x1 img_wrapper">
                              <Image
                    ...
                    .map((_) => (
                      <div className="col-md-6 col-lg-4 mb-5 pe-4 ">
                        <Link
                          href="/each-solution"
                          style={{ textDecoration: "none" }}
                          class="card py-4 px-2 main-solution-card bd-top-green2"
                        >
                          <div class="card-body">
                            <div className="icon position-relative ms-2 mb-3 ratio ratio-1x1 img_wrapper">
                              <Image
