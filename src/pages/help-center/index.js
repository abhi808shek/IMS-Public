...
const HelpCenter = () => {
  return (
        ...
        <div className='row justify-content-center align-items-center'>
            ...
            <div className='col-12 col-lg-6'>
                <div class="container help_form my-5">
                    <div class="form-wrapper p-5 p-lg-4 p-xl-5 shadow bg-white rounded">
    ...
    <div class="help-section training position-relative">
        <div class="row">
            <div class="col-12 col-lg-5 d-flex justify-content-end px-5 pe-lg-5">
            ...
            <div class="col-12 col-lg-7 training_resources_bg bg3 mt-5 mt-md-0 px-5 ps-lg-5">
    ...
    <div class="help-section training position-relative">
        <div class="row">
            <div class="col-12 col-lg-5 training_resources_bg bg4 d-flex justify-content-end px-5 pe-lg-5">
                <div className="training-column w-80">
                    <div class={` ${roboto.className} section-title text-center`}>Getting Started</div>
                    {
                        [1, 2, 3, 4].map(i => (
            ...
            <div class="col-12 col-lg-7 mt-5 mt-md-0 px-5 ps-lg-5">
                <div className="training-column">
                    <div class={` ${roboto.className} section-title text-center`}>Training Resources</div>
                    {
                        [1, 2, 3].map(i => (
