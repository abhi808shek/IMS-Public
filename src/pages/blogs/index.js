      ...
      <div className="aboutus_hero">
        <div className="row justify-content-between align-items-center hero_container">
          <div className="col-5 leftpanal">
            <h1 className={`${roboto.className} fw-bold mb-5`}>
            ...
            <div className="d-flex justify-content-start align-ites-center position-relative">
              ...
              <button
                type="button"
                class="btn primary_btn position-absolute"
                style={{ right: "-100px", bottom: 0, height: "110%" }}
              >
                Try Sortly Free
              </button>
            </div>
              ...
              {Array(15)
                ...
                .map((e, i) => (
                  ...
                  >
                    <div
                      key={`blogsCard` + i}
                      class={`card rounded blogs-card mb-4 position-relative ${
                        i % 2 === 0 ? "card1" : "card2"
                      }`}
                    >
                      ...
                      <div class="card-body d-flex flex-column justify-content-end">
                        <span
                          class="badge rounded-pill bg-light text-dark position-absolute"
                          style={{ top: "1rem" }}
                        >
                          Grow
                        </span>
                        <h5 class={roboto.className + ` card-title`}>
                        ...
                        <span className="d-flex align-items-center">
                          ...
                          <span
                            className={
                              roboto.className + ` text-white profile-title`
                            }
                          >
                            18 Apr, 2025
                          </span>
