    ...
    <>
        ...
        <div className="row justify-content-between align-items-center hero_container">
          <div className="col-12 col-lg-5 leftpanal mb-5 mb-lg-0">
            ...
            <div className="d-flex justify-content-start align-items-center position-relative email_wrapper">
              ...
              <button
                type="button"
                className="btn primary_btn position-absolute email_btn"
              >
                Try Sortly Free
              </button>
            </div>
          ...
          <div className="col-12 col-lg-7 position-relative">
            <div className="blog_hero_img position-relative">
              <Image
                ...
                src="/images/pages/blogs/bg2.svg"
                alt="upload"
                fill
                style={{ objectFit: "contain" }}
              />
              <Image
                className="me-4 hero_img_bg"
                src="/images/pages/about-us/bg2.svg"
                alt="upload"
                fill
                style={{ objectFit: "contain" }}
              />
      ...
      <div className="row blog_wrapper position-relative">
        <div
          className={`${
            roboto.className
          } col-8 col-md-4 col-lg-3 blogs-filter ${
            show ? "visible" : "hidden"
          }`}
        >
          <div>
          ...
          {filterData.map((filterItem) => (
            <div
              className={`filter-item d-flex justify-content-between ${
            ...
            >
              <span className="d-flex align-items-center">
                ...
                >
                  <path
                    d="M7.30759 8.64641L0.80281 2.14163L1.5707 1.37373L9.19693 8.99996L1.5707 16.6262L0.80281 15.8583L7.30759 9.35351L7.66114 8.99996L7.30759 8.64641Z"
                    stroke="#0D0D0D"
                  />
                </svg>
                <span
                  className={roboto.className + `me-2  filter-text fw-medium`}
                >
                  {filterItem}
                </span>
              </span>
        ...
        <div className="col-12 col-md-8 col-lg-9 ps-md-0">
          <div className="row d-md-none">
            <p
              className={
                roboto.className +
                `fw-medium mobile_title d-flex align-items-center`
              }
            >
              <span>
                <MenuLineIcon
          ...
          <div className="row">
            {[1, 2, 34, 5, 6, 67, 67, 7, 7, 78, 8, 8, 8, 8, 8].map((e, i) => (
              <Link
                href="/blog-details"
                style={{ textDecoration: "none" }}
                className="col-md-6 col-lg-4 px-3"
              >
                <div
                  key={`blogsCard` + i}
                  className={`card  blogs-card  position-relative ${
                    i % 2 === 0 ? "card1" : "card2"
                  }`}
                >
                  ...
                  <div className="card-body d-flex flex-column justify-content-end p-0 position-relative">
                    <span
                      className={
                        roboto.className +
                        ` badge rounded-pill bg-light fw-medium  position-absolute top-0 start-0`
                      }
                    >
                      Grow
                    </span>
                    ...
                    <span className="d-flex align-items-center">
                      <Image
                        ...
                        src="/images/pages/blogs/card-profile.png"
                        alt="profile"
                        width={24}
                        height={24}
                      />
                      <span
                        className={
                          roboto.className +
                          ` text-white profile-title me-3 fw-medium`
                        }
                      >
                        By Jason Carter
                      </span>
                      <Image
                        className="me-1"
                        src="/images/pages/blogs/calendar.svg"
                        alt="calendar"
                        width={10}
                        height={10}
                      />
                      <span
                        className={
                          roboto.className +
                          ` text-white profile-title fw-medium`
                        }
                      >
                        18 Apr, 2025
                      </span>
          ...
          <div className="blogs-pages d-flex align-items-center justify-content-center my-5">
            <Image
              ...
              src="/images/pages/blogs/left.svg"
              alt="left-arrow"
              width={32}
              height={32}
            />
            ...
            <Image
              className="arrow mx-2"
              src="/images/pages/blogs/right.svg"
              alt="left-arrow"
              width={32}
              height={32}
            />
