					...
					<div className="col-md-9">
						<div className="main_solution_content pb-0">
							<div className="container mb-5">
								<h3 className={`${roboto.className} fw-bold mb-5 w-75`}>Stay on top of your business’svaluable assets.<br />Browse Sortly’s asset tracking solutions</h3>
							</div>
										...
										Array(15).keys().map(_ => (
											<div className="col-md-6 col-lg-4 mb-5 pe-4">
												<div class="help_card card py-4 px-2">
													<div class="card-body">
														<div className='mb-3'>
															<Image src="/images/pages/main-industry/industry.svg" alt="upload" height="16" width="16" />
														</div>
														<h5 className={roboto.className+" mb-3 fw-bold card-title"}>Antiques</h5>
