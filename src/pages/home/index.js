...
>>>>>>> 246ff59380fadd27fc2005c7a52c939ee0e1b42a
...
=======
            <div className="col-lg text_left px-0 mb-5 mb-lg-0">
              <div className="header_tag_pill display-flex align-items-center py-2 px-3">
                <FlashLight className="icon me-1 animate_plus" />
                <span>Revolutionary AI Technology</span>
              </div>
              <h1 className="gradient-text">
                ...
                <span className="mb-0">
                  <Image
                    src="/images/pages/home-page/curvy-figure.svg"
                    alt="upload"
                    width={300}
                    height={20}
                  />
              ...
              <div className="flex-column d-flex flex-md-row home_btn align-items-center">
                <button
                  type="button"
                  className="btn primary_btn_lg me-md-4 mb-3 mb-md-0 "
                >
                  <span className="me-2">
              ...
              <div className="flex-column flex-md-row d-flex align-items-center trusted_users">
                <div className="d-flex users_wrapper me-4 mb-3 mb-md-0">
                  <div className="rounded-circle position-relative users">
                    <Image
                      src="/images/pages/home-page/bg1.jpg"
                      alt="upload"
                      fill
                  ...
                  <div className="rounded-circle position-relative users">
                    <Image
                      src="/images/pages/home-page/bg2.jpg"
                      alt="upload"
                      fill
                      style={{ objectFit: "cover" }}
                    />
                ...
                <div className="text-center text-md-right">
                  <p className="title mb-0 fw-semibold">
            ...
            <div className="col-lg px-0">
              <div className="position-relative">
                ...
                <div className="hero_img position-relative ratio ratio-1x1 backdrop-blur-sm shadow-xl">
                  <Image
                    src="/images/pages/home-page/bg3.png"
                    alt="upload"
                    fill
                    style={{ objectFit: "cover" }}
                  />
      ...
      <div className="container simple_inventory">
        <div className="row justify-content-center align-items-center simple_inventory_heading">
          <div className="col-md-11 col-lg-12 text-center">
            <h2 className={`${roboto.className} fw-bold`}>
              One platform <span>SIMPLE</span> inventory management and accounts
              software
            </h2>
          </div>
          <div className="col-8 text-center sub_title">
            <p className={`${roboto.className} fw-bold`}>
              “So simple, it just works.” <br />
              You read it right, <span>SIMPLE</span>.
            </p>
          </div>
          <div className="col-10">
            <div className="d-flex justify-content-center align-items-center">
              <button type="button" className="btn secondary_fill_btn me-2">
                See All Features
              </button>
        ...
        <div className="row simple_inventory_card_wrapper align-items-center">
          <div className="col-4 col-md-2 d-flex">
            <div className="card">
              <div className="card_img ratio ratio-1x1">
                <Image
                  src="/images/pages/home-page/icon-order.svg"
                  alt="upload"
                  fill
                  style={{ objectFit: "cover" }}
                />
          ...
          <div className="col-4 col-md-2 d-flex">
            <div className="card">
              <div className="card_img ratio ratio-1x1">
                <Image
                  src="/images/pages/home-page/icon-invoicing.svg"
                  alt="upload"
                  fill
                  style={{ objectFit: "cover" }}
                />
          ...
          <div className="col-4 col-md-2 d-flex">
            <div className="card">
              <div className="card_img ratio ratio-1x1">
                <Image
                  src="/images/pages/home-page/icon-challan.svg"
                  alt="upload"
                  fill
                  style={{ objectFit: "cover" }}
                />
          ...
          <div className="col-4 col-md-2 d-flex">
            <div className="card">
              <div className="card_img ratio ratio-1x1">
                <Image
                  src="/images/pages/home-page/icon-report.svg"
                  alt="upload"
                  fill
                  style={{ objectFit: "cover" }}
                />
          ...
          <div className="col-4 col-md-2 d-flex">
            <div className="card">
              <div className="card_img ratio ratio-1x1">
                <Image
                  src="/images/pages/home-page/icon-items.svg"
                  alt="upload"
                  fill
                  style={{ objectFit: "cover" }}
                />
          ...
          <div className="col-4 col-md-2 d-flex">
            <div className="card">
              <div className="card_img ratio ratio-1x1">
                <Image
                  src="/images/pages/home-page/icon-ledger.svg"
                  alt="upload"
                  fill
                  style={{ objectFit: "cover" }}
                />
      ...
      <div className="get_demo position-relative">
        ...
        <div className=" container ">
          <div className="heading_wrapper text-center mb-5">
            ...
            <p className="mb-4 mb-xl-5 sub_heading">
              Prediko help shopify brands make smarter forecasts and create POs
              faster.
            </p>
            <div className=" row flex-column flex-md-row justify-content-center align-items-center">
              <div className="col-11 col-md-12">
                <button
                  type="button"
                  className="btn primary_btn mb-4 mb-md-0 me-md-3"
                >
                  Get Demo
                </button>
                <button type="button" className="btn white_outline_btn_md ">
          ...
          <div className="row justify-content-end justify-content-md-around align-items-center p-4 p-md-5">
            <div className="col-10 col-md-5 d-flex justify-content-end mb-5 mb-md-0">
              <div className="ratio ratio-4x3 position-relative img_wrapper">
                <Image
                  src="/images/pages/home-page/bg7.svg"
                  alt="upload"
                  fill
                  style={{ objectFit: "cover" }}
                />
            ...
            <div className="col-10 col-md-5">
              <p className={`${roboto.className} title`}>
              ...
              <button type="button" className="btn primary_btn btn_md">
                Submit
              </button>
            </div>
          </div>
        ...
        <div className="software_product_wrapper left  ps-3 pe-5 py-md-5 px-5">
          <div className="row justify-content-start justify-content-md-around align-items-center p-4 p-md-5">
            ...
            <div className="col-10 col-md-5 d-flex justify-content-end order-1 order-md-2 mb-3 mb-md-0">
              <div className="ratio ratio-4x3 position-relative img_wrapper">
                <Image
                  src="/images/pages/home-page/bg4.svg"
                  alt="upload"
                  fill
                  style={{ objectFit: "cover" }}
                />
        ...
        <div className="possibilities_wrapper_container row">
          <div className="row justify-content-center top_heading_wrapper z-1">
            <div className="col-11 col-lg-8 text-center scale-hover">
              ...
              <h3
                className={`${roboto.className} top_heading fw-bod text-center mb-4`}
              >
                One Platform, Endless Possibilities
              </h3>
              <p
                className={`${roboto.className} sub_heading fw-bod text-center`}
              >
                Experience the future of inventory management with our
                AI-powered system. Transform <br />
                your operations with cutting-edge features designed for the
                modern enterprise.
              </p>
            </div>
          </div>
          <div className="row column_gap_4 justify-content-center mx-0 feature_1">
            <div className="col-lg left_panal position-relative px-0 mb-5 mb-lg-0">
              <div className="img_wrapper_outer position-relative">
                <div className="image_wrapper ratio ratio-4x3 position-relative">
                  <Image
                    src="/images/pages/home-page/bg8.jpg"
                    alt="upload"
                    fill
                    style={{ objectFit: "cover" }}
                  />
                </div>
                <div className="img_gradiant position-absolute"></div>
              </div>
            ...
            <div className="col-lg inventory_control_wrapper transform px-0 position-relative">
              ...
              <h4
                className={`${roboto.className} title fw-bod text-center mb-4`}
              >
                Complete Inventory Control
              </h4>
              <p className={`${roboto.className} sub_title  mb-4`}>
                Experience next-level inventory management with our AI-powered
                solution that learns and adapts to your unique business
                    ...
                    <div className="row justify-content-start mx-0 column_gap_1">
                      <div className="col-auto px-0">
                        <div className="img_bg position-relative">
                          <div className="gradient-pulse-bg position-absolute">
                            {" "}
                          </div>
              ...
              <div className="row mx-0 align-items-center column_gap_4 justify-content-center">
                <div className="col-lg-5 px-0 mb-5 mb-lg-0">
                  <div className="workflow_list">
                    <h3 className={`${roboto.className} fw-bold mb-3`}>
...
>>>>>>> 246ff59380fadd27fc2005c7a52c939ee0e1b42a
                        ...
                        <div className="flex-grow-1">
                          <p className="card_text mb-0 fw-semibold">
                            Purchase Orders
                          </p>
                          <p className="text_sm text_gray mb-0">
                ...
                <div className="col-lg px-0">
                  <div className="worflow_img_wrapper position-relative">
                    <div className="worflow_img position-relative ratio ratio-4x3">
                      <Image
                        src="/images/pages/home-page/bg9.jpg"
                        alt="upload"
                        fill
                    ...
                    <div className="white_card worflow_card position-absolute">
                      <div className="d-flex justify-content-center align-items-center">
                        ...
                        <div>
                          <p className="fw-semibold title mb-0">
                            Active Workflows
                          </p>
              ...
              <div className="row column_gap_4 justify-content-center align-items-center mx-0 position-relative">
                ...
                <div className="col-lg px-0 mb-5 mb-lg-0">
                  <div className="advance_management_img_wrapper position-relative">
                    <div className="advance_management_img posotion-relative ratio ratio-4x3">
                      <Image
                        src="/images/pages/home-page/bg10.jpg"
                        alt="upload"
                        fill
                        style={{ objectFit: "cover" }}
                      />
                ...
                <div className="col-lg px-0">
                  <div className="advance_management_list">
                    ...
                    <p className="text_gray mb-4">
                      Take control of your business with comprehensive ledger
...
>>>>>>> 246ff59380fadd27fc2005c7a52c939ee0e1b42a
        ...
        <div className="price_container">
          ...
          <div className="row justify-content-center gap_2 position-relative pricing_cards">
            <div className="position-absolute inset_0 price-card-bg-custom"></div>
            <div className="col-md-4 col-xl-3 px-xl-0">
              <div className="pricing_card">
                <h3 className="fw-semibol mb-2">Starter</h3>
                <p className="fw-bold card_sub_heading mb-3">
                  $49<span className="text_mute">/month</span>
                </p>
                <ul className="check_list list-unstyled">
                  <li>
                    <CheckLine className="icon me-2" />
                ...
                <button
                  type="button"
                  className="btn white_outline_btn_md w-100"
                >
                  Get Started
                </button>
              </div>
            ...
            <div className="col-md-4 col-xl-3 px-xl-0">
              <div className="pricing_card most_popular position-relative">
                ...
                <button type="button" className="btn primary_btn w-100">
                  Get Started
                </button>
              </div>
            </div>
