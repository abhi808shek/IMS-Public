...
const Enterprise = () => {
  ...
  return (
    ...
    <div className='enterprise_hero'>
        <div className='row justify-content-between aign-items-start px-5 position-relative'>
        ...
        <div className='custom_container container '>
            <div className='row justify-content-center align-items-center'>
                <div className='col-12 each_feature_heading'>
                    <h2 className={`${roboto.className} mb-4 text-center`}>Why use Sortly for your large<br/> business?</h2>
